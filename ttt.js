...
function myfunc() {
  ...
  if ((b1 == 'X' || b1 == 'x') && (b2 == 'X' || b2 == 'x') && (b3 == 'X' || b3 == 'x')) {
    document.getElementById("print").innerHTML = "You won Player X";
    ...
    document.getElementById("print").innerHTML = "You won Player O";
    document.getElementById('b4').disabled = true;
    document.getElementById('b5').disabled = true;
    document.getElementById('b6').disabled = true;
    document.getElementById('b7').disabled = true;
  ...
  else if ((b1 == 'O' || b1 == 'o') && (b4 == 'O' || b4 == 'o') && (b7 == 'X' || b7 == 'o')) {
    document.getElementById('print').innerHTML = "You won Player O";
    document.getElementById('b8').disabled = true;
    document.getElementById('b2').disabled = true;
    document.getElementById('b3').disabled = true;
...
// const loc = document.querySelector('btn-f');
function func_2() {
  location.reload();
...
// loc.addEventListener('click', func_2());
//here we check the turn of the player
flag = 1;
function func_3() {
  if (flag == 1) {
